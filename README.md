# AEDIST-Feasibility-Demonstrator
...
```
cd existing_repo
git remote add origin https://src.koda.cnrs.fr/minh.ha.duong/aedist-feasibility-demonstrator.git
git branch -M main
...
- [ ] [Set up project integrations](https://src.koda.cnrs.fr/minh.ha.duong/aedist-feasibility-demonstrator/-/settings/integrations)
